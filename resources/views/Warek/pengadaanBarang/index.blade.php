...
<div class="row mb-2">
  <div class="col-sm-12 col-lg-12 d-flex justify-content-end">
    <a href="{{ route('warek.pengadaanBarang.detail') }}" class="btn btn-sm btn-primary rounded mt-1 text-center fw-bold text-white text-decoration-none">Detail</a>
  </div>
</div>
<table class="table overflow-auto table-responsive">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="{{ route('warek.pengadaanBarang.pengumumanPengadaan') }}">Pengadaan Server untuk Laboratorium Komputer</a></td>
      <td>Fakultas Psikologi dan Ilmu Pendidikan</td>
      <td> <a href="#" class="btn badge bg-primary">ON</a></td>
      <td>Rp. 100.000.000,-</td>
      <td class="text-center"><a href="{{ route('warek.pengadaanBarang.pengumumanPengadaan') }}">5</a></td>

            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="{{asset('login/img/bg-logo.png')}}" class="img-thumbnail" alt="logo"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{asset('forgot-password')}}">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="{{route('auth.registrasi')}}">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>

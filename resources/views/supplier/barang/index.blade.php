...
<h5 class="bg-warning p-2 rounded text-center">Pengadaan yang Diikuti</h5>
    <div class="d-flex justify-content-end mb-2">
        <a href="{{ route('supplier.barang.create') }}" class="btn btn-sm btn-primary">Tambah</a><br>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
          <td>1</td>
          <td>PBA - 0001</td>
          <td><a href="{{ route('supplier.barang.detail') }}" class="card-title text-decoration-none text-primary">Pengadaan Komputer dan Sever untuk Laboratorium Komputer </a></td>
          <td class="text-center"><a href="#" class="badge badge-secondary text-decoration-none">Submited</a></td>
          <td class="text-center"><a href="{{ route('supplier.barang.edit') }}" class="btn btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
        ...
        <tbody>
            <td>2</td>
          <td>PBA - 0002</td>
          <td><a href="{{ route('supplier.barang.detail') }}" class="card-title text-decoration-none text-primary">Pengadaan Mesin CNC untuk Laboratorium Teknik Mesin </a></td>
